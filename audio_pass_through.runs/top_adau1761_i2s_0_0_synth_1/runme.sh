...
HD_PWD='C:/Git/audio_pass_through/audio_pass_through.runs/top_adau1761_i2s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_adau1761_i2s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_adau1761_i2s_0_0.tcl
