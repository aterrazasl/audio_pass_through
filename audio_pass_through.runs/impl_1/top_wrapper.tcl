...
namespace eval ::optrace {
  variable script "C:/Git/audio_pass_through/audio_pass_through.runs/impl_1/top_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Git/audio_pass_through/audio_pass_through.runs/synth_1/top_wrapper.dcp
